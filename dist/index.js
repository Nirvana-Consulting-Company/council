...
import { printBanner, printHelp, printSystem, printError, printUser, } from "./ui.js";
            ...
            switch (cmd) {
                ...
                case "/queue": {
                    try {
                        ...
                        printSystem(`Queued! Gist: ${result.url} (${result.filename})`);
                ...
                case "/export": {
                    try {
                        const path = await orchestrator.saveTranscript(arg || undefined);
                        printSystem(`Transcript saved: ${path}`);
                    }
                    catch (err) {
